...
3. Use your local database settings to create an .env file in the server directory that has all the variables required in query.js.  
...
11. Open localhost at the client port in your favorite browser.
